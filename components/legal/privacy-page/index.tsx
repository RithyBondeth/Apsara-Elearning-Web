...
export function PrivacyPageContent() {
  ...
  return (
    <div className="landing-page relative min-h-screen overflow-x-hidden text-foreground">
      ...
      <main className="relative z-10 px-5 pt-28 pb-24 sm:px-6 sm:pt-32">
        <section className="mx-auto max-w-7xl">
          <div className="relative overflow-hidden rounded-[2rem] border border-border bg-background/88 px-6 py-10 shadow-[0_28px_80px_-48px_rgba(35,131,226,0.42)] backdrop-blur-sm sm:px-10 sm:py-14 lg:px-14">
            <div
              aria-hidden
              className="absolute -top-28 -right-24 size-80 rounded-full bg-[#2383e2]/10 blur-3xl"
            />
            <div
              aria-hidden
              className="absolute -bottom-24 left-1/3 size-64 rounded-full bg-emerald-400/8 blur-3xl"
            />
            ...
            <div className="relative grid items-end gap-10 lg:grid-cols-[minmax(0,1fr)_17rem]">
              <div>
                ...
                <h1 className="max-w-4xl text-4xl font-bold tracking-[-0.04em] text-balance sm:text-5xl lg:text-6xl">
                  {t("title")}
                </h1>
                <p className="mt-5 max-w-3xl text-base leading-7 text-pretty text-muted-foreground sm:text-lg sm:leading-8">
                  {t("intro")}
                </p>
              ...
              <div className="hidden rounded-[1.75rem] border border-[#2383e2]/16 bg-linear-to-br from-[#2383e2]/10 via-background/85 to-emerald-400/10 p-5 lg:block">
          ...
          <aside className="lg:sticky lg:top-24">
            <div className="rounded-[1.5rem] border border-border bg-background/92 p-4 shadow-[0_18px_50px_-38px_rgba(31,77,145,0.35)] backdrop-blur-sm">
              <div className="mb-3 flex items-center gap-2 px-3 pt-2 text-sm font-semibold">
                <Database className="size-4 text-[#2383e2]" />
                {t("toc")}
              </div>
              <nav
                aria-label={t("toc")}
